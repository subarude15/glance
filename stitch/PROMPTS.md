# Stitch prompts — punk & rally

Copy/paste into [stitch.withgoogle.com](https://stitch.withgoogle.com/). Prefer **Experimental / Pro** when uploading a screenshot from `mockups/`.

Import `DESIGN.md` (repo root) into the Stitch project first so colors/type stick.

## Seed — redesign Home desktop
